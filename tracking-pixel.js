 ...
 * Inserta este script en tu index.html (antes del </body>)
 * <script src="https://tu-api.com/tracking-pixel.js"></script>
 */

(function() {
    // Configuración
    const API_ENDPOINT = 'https://tu-api-domain.com/api/track'; // Cambia por tu URL
